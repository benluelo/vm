...
- functions 
  ```
  fn f(a: int, b: SomeType, cb: fn(T): U): ReturnType = #[ expr ]#
  ```
...
- type inference/ "deferring":
  ...
  ```
  fn g<T, U>(b: bool, t: T, u: U): _ = if b then t else u
  ```

  inferred to be 'Result<int, ErrTooSmall | ErrTooLarge>'

  ```
  fn h(i: int): Result<int, _> = if i < 10
